...
public class Lab1
{
    ...
    *********************************************************************/
	...
	public static void main(String[] args)
	{
    	...
    	//Output population report
    	System.out.print("\n\n\tThe estimated population is       : " + year2Pop + " for year 2. " +
    	                 "\n\n\tThe estimated population is       : " + year3Pop + " for year 3. " +
		                 "\n\n\tThe estimated population growth is: " + fmt.format(percentGrowth) + "% per year. \n\n\n\n");
